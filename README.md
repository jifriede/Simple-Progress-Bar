...
## Assumptions
**Assumes you are not printing anything to the consol while the bar is active**. This is very important! You can use console cursor locations to fix this assumption, but I designed this to be a very simple progress bar.
## Authors
Jared-Isaac Friedel
## Created
2026-04-30
